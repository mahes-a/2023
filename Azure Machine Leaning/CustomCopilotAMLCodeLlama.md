...
- Add an HTTP activity under advanced and make the call to code llama endpoint created in previous section with the authentication key
 ...
 - Add a message and send the response from code lama aml endpoint and the formula value of Index(Topic.output,1).'0'
...
**Publish the Conversational plugin , the Copilot and enable the Teams channel**
 ...
 - Remove the activities and add a Redirect activity and select the conversation plugin created
   ...
   <img width="629" alt="image" src="https://github.com/mahes-a/2023/assets/120069348/002777f9-156e-46dd-8e8a-fa0a6b376670">
